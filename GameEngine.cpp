...
void GameEngine::UpdateSprites(int wallArray[16][10], int wallCounter, Bitmap* blobbo, Bitmap* timy)
{
	...
	for (siSprite = m_vSprites.begin(); siSprite != m_vSprites.end(); /* siSprite++ */)
	{
		...
		if (saSpriteAction & SA_KILL)
		{
			...
			if ((*siSprite)->GetBitmap() == blobbo || (*siSprite)->GetBitmap() == timy) { // control of sprites hitting walls
				BOOL control = false;
				for (int i = 0; i < 16; i++)
				{
					for (int j = 0; j < 10; j++)
					{
						if (wallArray[i][j] != 0 && !control) {
							if ((*siSprite)->GetPosition().right >= wallCounter + 5 + i * 50 && (*siSprite)->GetPosition().right <= wallCounter + 45 + i * 50) {
								if (((*siSprite)->GetPosition().top >= j * 50 + 5 && (*siSprite)->GetPosition().top <= 45 + j * 50) || ((*siSprite)->GetPosition().bottom >= j * 50 + 5 && (*siSprite)->GetPosition().bottom <= 45 + j * 50)) {
									control = true;
									rcOldSpritePos.right = rcOldSpritePos.right - 10;
									rcOldSpritePos.left = rcOldSpritePos.left - 10;
									if (j>5) {
										rcOldSpritePos.bottom = rcOldSpritePos.bottom - 10;
										rcOldSpritePos.top = rcOldSpritePos.top - 10;
									}
									else {
										rcOldSpritePos.top = rcOldSpritePos.top + 10;
										rcOldSpritePos.bottom = rcOldSpritePos.bottom + 10;
							...
							else if ((*siSprite)->GetPosition().left >= wallCounter + 5 + i * 50 && (*siSprite)->GetPosition().left <= wallCounter + 45 + i * 50) {
								if (((*siSprite)->GetPosition().top >= j * 50 + 5 && (*siSprite)->GetPosition().top <= 45 + j * 50) || ((*siSprite)->GetPosition().bottom >= j * 50 + 5 && (*siSprite)->GetPosition().bottom <= 45 + j * 50)) {
									control = true;
									rcOldSpritePos.left = rcOldSpritePos.left + 10;
									rcOldSpritePos.right = rcOldSpritePos.right + 10;
							...
							else if ((*siSprite)->GetPosition().top >= j * 50 + 5 && (*siSprite)->GetPosition().top <= 45 + j * 50) {
								if (((*siSprite)->GetPosition().right >= wallCounter + i * 50 + 5 && (*siSprite)->GetPosition().right <= wallCounter + 45 + i * 50) || ((*siSprite)->GetPosition().left >= wallCounter + i * 50 + 5 && (*siSprite)->GetPosition().left <= wallCounter + 45 + i * 50)) {
									control = true;
									rcOldSpritePos.top = rcOldSpritePos.top + 10;
									rcOldSpritePos.bottom = rcOldSpritePos.bottom + 10;
									break;
							...
							else if ((*siSprite)->GetPosition().bottom >= j * 50 + 5 && (*siSprite)->GetPosition().bottom <= 45 + j * 50) {
								if (((*siSprite)->GetPosition().right >= wallCounter + i * 50 + 5 && (*siSprite)->GetPosition().right <= wallCounter + 45 + i * 50) || ((*siSprite)->GetPosition().left >= wallCounter + i * 50 + 5 && (*siSprite)->GetPosition().left <= wallCounter + 45 + i * 50)) {
									control = true;
									rcOldSpritePos.bottom = rcOldSpritePos.bottom - 10;
									rcOldSpritePos.top = rcOldSpritePos.top - 10;
